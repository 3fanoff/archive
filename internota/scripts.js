...
function full_short(){
	...
	$('.full_short').click(function(){
		...
		$(this).next('.text_full').slideToggle();
...
function full_short2(){
	$('.text_full2').prev('p').append(' <a href="#more" id="more_serv">Подробнее</a>');
	$('#more_serv, .benefit_box._all li a').click(function(){
		$('.full_short2').trigger('click');
		return false;
	});
	$('.full_short2').click(function(){
		$(this).toggleClass('_fs2');
		$('.text_full2, .benefits_full').slideToggle();
		$('.benefit_box._all').slideToggle();
		$('#more_serv').toggle();
	});
}
