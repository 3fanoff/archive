	...
	init : function(hash) {
		//try {
			...
			this.jq.html('<table' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
				<tr>\
					<td class="l"><div id="leftBlock"><span></span><span class="limit"></span><img id="leftBegun" ondragstart="return false;" src="images/filter/trackbar/left_bar.png" width="15" height="15" alt="" /></div></td>\
					<td class="c" id="centerBlock"></td>\
					<td class="r"><div id="rightBlock"><span></span><span class="limit"></span><img id="rightBegun" ondragstart="return false;" src="images/filter/trackbar/right_bar.png" width="15" height="15" alt="" /></div></td>\
				</tr>\
			</table>');
			// Is all right?
			if (this.onMove == null) {
